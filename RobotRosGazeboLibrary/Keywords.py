...
class Keywords:
    ...
    @keyword("Verify link ${link_name} at ${x:-?\d*\.?\d+} ${y:-?\d*\.?\d+} ${z:-?\d*\.?\d+}")
    ...
    @keyword("Verify link ${link_name} at ${x:-?\d*\.?\d+} ${y:-?\d*\.?\d+} ${z:-?\d*\.?\d+} relative to ${reference_frame}")
    ...
    @keyword("Verify model ${model_name} at ${x:-?\d*\.?\d+} ${y:-?\d*\.?\d+} ${z:-?\d*\.?\d+}")
    ...
    @keyword("Connect on port ${port:\d+}")
